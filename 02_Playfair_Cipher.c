...
The replaced text(j with i) h e l l o t h e r e
The cipher has to enter 1 bogus char.It is either 'x' or 'z'

Value of length is 12.
The final text is: h e l x l o t h e r e x

The Cipher text is:
 k g y v r v q m g i k u
--------------------------------
Process exited after 16.8 seconds with return value 0
